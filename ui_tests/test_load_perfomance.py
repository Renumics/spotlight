...
def test_load_default_dataset(
    default_performance_dataset: Any,
    webdriver: WebDriver,
    frontend_base_url: str,
    ...
    from ui_tests._autogenerated_ui_elements import DataTestTags  # noqa: F401
...
def test_load_many_cols(
    many_cols_performance_dataset: Any,
    webdriver: WebDriver,
    frontend_base_url: str,
    request: FixtureRequest,
    results_bag: Dict[str, Any],
...
def test_load_large_embeddings(
    large_embeddings_performance_dataset: Any,
    webdriver: WebDriver,
    frontend_base_url: str,
    request: FixtureRequest,
    results_bag: Dict[str, Any],
...
def test_load_many_cols_large_embeddings(
    many_cols_large_embeddings_performance_dataset: Any,
    webdriver: WebDriver,
    frontend_base_url: str,
    request: FixtureRequest,
    results_bag: Dict[str, Any],
