...
def generate_tallymarks_dataset(
    ...
    with Dataset(output_h5_file, "w") as dataset:
        ...
        for i, filename in enumerate(list(os.listdir("data/video"))):
            videos_lookup[i + 2] = os.path.join("data/video", filename)
        ...
        for image, label, encoded_row in list(
            ...
            dataset.append_row(
                ...
                now=datetime.datetime.now() if label > 0 else None,
